...
export const COMPONENT_DEFINITIONS: Record<ComponentType, ComponentDef> = {
  ...
  seven_segment: {
    ...
    pins: [
      ...
      { id: 'pin_g', name: 'G', x: 6, y: 6 },
      { id: 'pin_f', name: 'F', x: 13, y: 6 },
      { id: 'pin_com1', name: 'COM1', x: 20, y: 6, type: 'ground' },
      { id: 'pin_a', name: 'A', x: 27, y: 6 },
      { id: 'pin_b', name: 'B', x: 34, y: 6 },

      // Bottom pins left-to-right (e, d, com2, c, dp)
      { id: 'pin_e', name: 'E', x: 6, y: 54 },
      { id: 'pin_d', name: 'D', x: 13, y: 54 },
      { id: 'pin_com2', name: 'COM2', x: 20, y: 54, type: 'ground' },
      { id: 'pin_c', name: 'C', x: 27, y: 54 },
      { id: 'pin_dp', name: 'DP', x: 34, y: 54 },
    ],
  },
  potentiometer: {
    type: 'potentiometer',
