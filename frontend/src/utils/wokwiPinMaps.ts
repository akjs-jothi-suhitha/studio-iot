...
export const WOKWI_PART_MAPS: Partial<Record<ComponentType, WokwiPartMap>> = {
  ...
  esp8266: {
    wokwiTag: 'wokwi-nodemcu-esp8266',
    width: 90,
    height: 54,
    usesWokwi: true,
    pins: [
      { id: 'pin_a0', name: 'A0', x: 3, y: 27, type: 'analog' },
      { id: 'pin_gnd1', name: 'GND', x: 3, y: 36, type: 'ground' },
      { id: 'pin_3v3', name: '3V3', x: 3, y: 45, type: 'power' },
      { id: 'pin_d0', name: 'D0', x: 12, y: 45, type: 'digital' },
      { id: 'pin_d1', name: 'D1/TX', x: 21, y: 45, type: 'digital' },
      { id: 'pin_d2', name: 'D2', x: 30, y: 45, type: 'digital' },
      { id: 'pin_d3', name: 'D3/RX', x: 39, y: 45, type: 'digital' },
      { id: 'pin_d4', name: 'D4', x: 48, y: 45, type: 'digital' },
      { id: 'pin_d5', name: 'D5', x: 57, y: 45, type: 'digital' },
      { id: 'pin_d6', name: 'D6', x: 66, y: 45, type: 'digital' },
      { id: 'pin_d7', name: 'D7', x: 75, y: 45, type: 'digital' },
      { id: 'pin_d8', name: 'D8', x: 84, y: 45, type: 'digital' },
      { id: 'pin_rx', name: 'RX', x: 84, y: 36, type: 'digital' },
      { id: 'pin_tx', name: 'TX', x: 84, y: 27, type: 'digital' },
      { id: 'pin_vin', name: 'VIN', x: 84, y: 18, type: 'power' },
      { id: 'pin_gnd2', name: 'GND', x: 75, y: 9, type: 'ground' },
      { id: 'pin_3v3_2', name: '3V3', x: 66, y: 9, type: 'power' },
      { id: 'pin_en', name: 'EN', x: 57, y: 9, type: 'passive' },
      { id: 'pin_rst', name: 'RST', x: 48, y: 9, type: 'passive' },
    ],
  },
  led: {
    wokwiTag: 'wokwi-led',
